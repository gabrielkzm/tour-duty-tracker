...
const tourSchema = new Schema(
    {
        ...
        ambassadorsAccepted: {type: [mongoose.Types.ObjectId], required: true},
        ambassadorsDeclinedWithReason: {type: [mongoose.Types.ObjectId], required: true},
        ambassadorsDeclinedWithoutReason: {type: [mongoose.Types.ObjectId], required: true},
        ...
        announcedDate: {type: Date, required: false},
    },
    {
        timestamps: true
    }
